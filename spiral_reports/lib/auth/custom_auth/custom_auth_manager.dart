...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    spiralReportsAuthUserSubject.add(
      SpiralReportsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SpiralReportsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SpiralReportsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SpiralReportsAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    spiralReportsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SpiralReportsAuthUser? currentUser;
