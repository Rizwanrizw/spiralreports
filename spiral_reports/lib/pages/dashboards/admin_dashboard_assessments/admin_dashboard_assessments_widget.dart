...
import 'admin_dashboard_assessments_model.dart';
export 'admin_dashboard_assessments_model.dart';

class AdminDashboardAssessmentsWidget extends StatefulWidget {
  const AdminDashboardAssessmentsWidget({
    super.key,
    bool? showAnimation,
    int? activeTab,
  ...
  @override
  State<AdminDashboardAssessmentsWidget> createState() =>
      _AdminDashboardAssessmentsWidgetState();
}

class _AdminDashboardAssessmentsWidgetState
    extends State<AdminDashboardAssessmentsWidget> {
  late AdminDashboardAssessmentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminDashboardAssessmentsModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: FFAppState().getAllAssessmentsAdminAPI(
        requestFn: () =>
            SpiralReportsAdminAPIGroup.getAllAssessmentsAdminCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final adminDashboardAssessmentsGetAllAssessmentsAdminResponse =
            snapshot.data!;
                                ...
                                children: [
                                  wrapWithModel(
                                    ...
                                    child: H1HeadingGroupWidget(
                                      ...
                                      subText:
                                          'Track all your assessments here',
                                    ),
                                  ),
                                  Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          context.pushNamed('createAssessment');
                                        },
                                ...
                                builder: (context) {
                                  final assessmentList =
                                      SpiralReportsAdminAPIGroup
                                              ...
                                              .assessmentList(
                                                adminDashboardAssessmentsGetAllAssessmentsAdminResponse
                                                    .jsonBody,
                                              )
                                              ?.toList() ??
                                          [];
                                  ...
                                  return FlutterFlowDataTable<dynamic>(
                                    ...
                                    dataRowBuilder: (assessmentListItem,
                                            assessmentListIndex,
                                            selected,
                                            onSelectChanged) =>
                                        DataRow(
                                      color: MaterialStateProperty.all(
                                        assessmentListIndex % 2 == 0
                                            ? FlutterFlowTheme.of(context)
                                                .secondaryBackground
                                            : Color(0xFFF9FAFB),
                                      ),
