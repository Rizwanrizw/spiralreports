...
import 'dart:async';
import 'user_dashboard_evaluations_widget.dart'
    show UserDashboardEvaluationsWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class UserDashboardEvaluationsModel
    extends FlutterFlowModel<UserDashboardEvaluationsWidget> {
  ...
  // Stores action output result for [Backend Call - API (Admin Refresh)] action in user_dashboard_evaluations widget.
  ...
  // Stores action output result for [Backend Call - API (Delete Evaluation)] action in IconButton widget.
  ApiCallResponse? apiResulti7c;
