...
import 'user_dashboard_evaluations_model.dart';
export 'user_dashboard_evaluations_model.dart';

class UserDashboardEvaluationsWidget extends StatefulWidget {
  const UserDashboardEvaluationsWidget({
    super.key,
    bool? showAnimation,
    int? activeTab,
  ...
  @override
  State<UserDashboardEvaluationsWidget> createState() =>
      _UserDashboardEvaluationsWidgetState();
}

class _UserDashboardEvaluationsWidgetState
    extends State<UserDashboardEvaluationsWidget> {
  late UserDashboardEvaluationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserDashboardEvaluationsModel());
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: (_model.apiRequestCompleter ??=
                                  Completer<ApiCallResponse>()
                                    ..complete(SpiralReportsUserAPIGroup
                                        .getAllEvaluationsCall
                                        .call(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final dataTableContainerGetAllEvaluationsResponse =
                                snapshot.data!;
                            ...
                            return Container(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final evalList = SpiralReportsUserAPIGroup
                                          .getAllEvaluationsCall
                                          .evaluationList(
                                            dataTableContainerGetAllEvaluationsResponse
                                                .jsonBody,
                                          )
                                          ?.toList() ??
                                      [];
