...
import 'admin_dashboard_evaluations_widget.dart'
    show AdminDashboardEvaluationsWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class AdminDashboardEvaluationsModel
    extends FlutterFlowModel<AdminDashboardEvaluationsWidget> {
  ...
  // Stores action output result for [Backend Call - API (Admin Refresh)] action in admin_dashboard_evaluations widget.
