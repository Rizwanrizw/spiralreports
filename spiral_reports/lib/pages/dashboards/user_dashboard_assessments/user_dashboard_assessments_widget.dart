...
import 'user_dashboard_assessments_model.dart';
export 'user_dashboard_assessments_model.dart';

class UserDashboardAssessmentsWidget extends StatefulWidget {
  const UserDashboardAssessmentsWidget({
    super.key,
    bool? showAnimation,
    int? activeTab,
  ...
  @override
  State<UserDashboardAssessmentsWidget> createState() =>
      _UserDashboardAssessmentsWidgetState();
}

class _UserDashboardAssessmentsWidgetState
    extends State<UserDashboardAssessmentsWidget> {
  late UserDashboardAssessmentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserDashboardAssessmentsModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: FFAppState().getAllAssessmentsUserAPI(
        requestFn: () => SpiralReportsUserAPIGroup.getAllAssessmentsCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final userDashboardAssessmentsGetAllAssessmentsResponse =
            snapshot.data!;
                                ...
                                builder: (context) {
                                  final assessmentList =
                                      SpiralReportsUserAPIGroup
                                              ...
                                              .assessmentData(
                                                userDashboardAssessmentsGetAllAssessmentsResponse
                                                    .jsonBody,
                                              )
                                              ?.toList() ??
                                          [];
